...
/* harmony export */   "default": () => (/* binding */ UserRecipes),
...
class UserRecipes {
  constructor() {
    this.events();
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.headers.common['X-WP-Nonce'] = meshijeData.nonce;
  }
  events() {
    ...
    const getImagesFiles = document.querySelector('.meshije-image-upload input');
  ...
  showAlert(message, type) {
    ...
    alertDiv.classList.add('px-4', 'py-3', 'mb-4', 'rounded', 'shadow-md', 'text-sm');
    ...
    switch (type) {
      ...
      case 'info':
        ...
        break;
      default:
        alertDiv.classList.add('bg-gray-100', 'border', 'border-gray-400', 'text-gray-700');
    }
    alertDiv.innerHTML = `
  ...
  handleDelete(recipeId) {
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(`${meshijeData.root_url}/wp-json/wp/v2/user-recipes/${recipeId}`).then(response => {
  ...
  editRecipe(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].patch(`${meshijeData.root_url}/wp-json/wp/v2/user-recipes/${recipeId}`, fieldToUpdate).then(response => {
      console.log(response.data); // Logging the response data
  ...
  fileReader(e) {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      const cssClass = 'overflow-hiddenrelative rounded-xl w-full min-h-[60vh] max-h-[60vh] h-[60vh] lg:h-[45vh] lg:min-h-[45vh] lg:max-h-[45vh] border-4 border-gray-200 cursor-pointer';
  ...
  uploadFileAndGetId(file) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(`${meshijeData.root_url}/wp-json/wp/v2/media`, formData, {
      headers: {
  ...
  createRecipe(e) {
    const featuredImageId = uploadedFileIds.length > 0 ? uploadedFileIds[0] : null;
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(`${meshijeData.root_url}/wp-json/wp/v2/user-recipes/`, ourPost).then(response => {
...
function ExampleReactComponent() {
  ...
  }, clickCount), ' ', "times."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    onClick: handleClick
  }, " click"));
}
...
/* harmony import */ var _UserRecipes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UserRecipes */ "./src/UserRecipes.js");
...
if (document.querySelector('#render-react-example-here')) {
  react_dom__WEBPACK_IMPORTED_MODULE_4___default().render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_scripts_ExampleReactComponent__WEBPACK_IMPORTED_MODULE_3__["default"], null), document.querySelector('#render-react-example-here'));
}

// Create an instance of UserRecipes
const userRecipes = new _UserRecipes__WEBPACK_IMPORTED_MODULE_1__["default"]();
})();
